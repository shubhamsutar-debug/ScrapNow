  ...
  return (
    <div className="min-h-screen bg-brand-bg flex flex-col justify-between">
      ...
      <main className="flex-1 max-w-7xl mx-auto w-full px-4 sm:px-6 lg:px-8 py-8 space-y-8">
        ...
        {/* 4 Summary Cards — NO "Earnings" used */}
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
          ...
          >
            ...
            <span className="text-[11px] text-emerald-600 font-bold">Active in progress</span>
          </div>
          ...
          >
            ...
            <span className="text-[11px] text-brand-text-secondary font-medium font-semibold">Total recycled</span>
          </div>
        ...
        <div className="bg-brand-card border border-brand-border rounded-3xl p-6 sm:p-8 shadow-xs space-y-6">
          ...
          {pendingRequests.length > 0 ? (
            ...
            <div className="text-center py-12 space-y-3 bg-brand-bg/50 rounded-2xl border border-brand-border">
              ...
              <h4 className="font-bold text-brand-text text-sm">No pending requests</h4>
